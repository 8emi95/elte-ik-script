...
print re.findall("[^0-9+\-,]+", "Kiss Pal 06-1-123-4567, Nagy Geza 06-10-234-345, Toth Bela +36-30-345-3211") #bármi csak amit ^ után felsorol nem
...
m = re.match("a(.*)fa(a(.*)t)", "almafaalatt") #1. (.*) 2. (a(.*)t) 3. (.*) belső
print m.group(1)
# lma
